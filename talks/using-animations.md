...
## [`TimeSlider widget`](https://developers.arcgis.com/javascript/latest/api-reference/esri-widgets-TimeSlider.html) &mdash; `animate features over time`
